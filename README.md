...
```bash
pip install jupyter_tomoyan_extension
```
...
```bash
pip uninstall jupyter_tomoyan_extension
```
...
# Change directory to the jupyter_tomoyan_extension directory
...
folder is located. Then you can remove the symlink named `jupyter_tomoyan_extension` within that folder.
